...
public class BankAccount {
	...
	public static boolean Authenticate(int checkAccNum, String checkPass){
		BankAccount myCopyDuck = new BankAccount();
		myCopyDuck.SetAcctInfo("Von Geburt", "nunyazbizniz", 3217,448922391,1);
		if(checkAccNum==myCopyDuck.accountNum && checkPass==myCopyDuck.password){
			return true;
		} else {
			return false;
		}
